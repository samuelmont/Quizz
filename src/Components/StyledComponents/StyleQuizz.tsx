...
export const InputLabel = styled.label`
  ...
  height: 3.5rem;
  ${InputRadio}:checked + & {
    background-color: #29326440;
    border: 1px solid #29326440;
  }
`;
...
export const Answered = styled.p <Props>`
  color: ${(props) => (props.bgColor === '#F8BCBC' ? '#29326488' : '#293264')};
